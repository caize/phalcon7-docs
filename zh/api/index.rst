...
.. toctree::
   ...
   Phalcon_Http_Client
   Phalcon_Http_Client_Adapter
   Phalcon_Http_Client_Adapter_Curl
   Phalcon_Http_Client_Adapter_Stream
   Phalcon_Http_Client_Exception
   ...
   Phalcon_Mvc_Model_Query_Builder_Insert
   Phalcon_Mvc_Model_Query_Builder_Join
   Phalcon_Mvc_Model_Query_Builder_Select
   Phalcon_Mvc_Model_Query_Builder_Update
   Phalcon_Mvc_Model_Query_Builder_Where
   Phalcon_Mvc_Model_Query_Exception
   ...
   Phalcon_Validation_Validator_Json
   ...
   Phalcon_Http_Client_AdapterInterface
